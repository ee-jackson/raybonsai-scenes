...
knitr::include_graphics(here::here("figures", "random-forest.png"))
```

## Create a forest of clustered individuals

```{r cluster-forest, eval = FALSE}
...
```{r, echo = FALSE, out.width = "100%"}
knitr::include_graphics(here::here("figures", "cluster-forest.png"))
```
